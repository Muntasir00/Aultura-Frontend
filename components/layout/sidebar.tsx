...
export default function Sidebar({isAdmin = false, isOpen, setIsOpen}: SidebarProps) {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "overflow-x-auto dark:bg-[#0f172a] w-64 border-r flex flex-col fixed inset-y-0 z-[70] transition-transform duration-300 border-slate-200 bg-white",
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">Altura</h1>
                        </div>
